					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<!-- 注册表单 -->
										<form class="form-horizontal" action="${pageContext.request.contextPath}/subject/save.do" role="form" method="post">

											<div class="form-group">
												<label class="col-sm-5 control-label no-padding-right" for="form-id"></label>

												<div class="col-sm-7">
													<input type="hidden" id="form-id" name="id" value="${subject.id}" class="col-xs-10 col-sm-5" />
												</div>
											</div>

											<div class="form-group">
												<label class="col-sm-5 control-label no-padding-right" for="form-field-1"> 课程名称 </label>

												<div class="col-sm-7">
													<input type="text" id="form-field-1" name="subjectName" value="${subject.subjectName}" placeholder="请输入课程的名称..." class="col-xs-10 col-sm-5" />
												</div>
											</div>

											<div class="form-group">
												<label class="col-sm-5 control-label no-padding-right" for="form-field-2"> 选课人数上限 </label>

												<div class="col-sm-7">
													<input type="text" id="form-field-2" name="limitStu" value="${subject.limitStu}" placeholder="请输入选课人数上限值..." class="col-xs-10 col-sm-5" />
												</div>
											</div>
