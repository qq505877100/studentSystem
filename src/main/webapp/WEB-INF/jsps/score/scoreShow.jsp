	...
	<body class="no-skin">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<%--这里隐藏一个学生的id，因为要用到学生id查询出所有的课程的分数信息--%>
									<div>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
			    ...
			    //动态的设置jqgrid的url地址，让它携带参数学生id去查询数据
				var studentId = $("#studentId").val();

				//获取studentId和subjectId方便点击选课时传递到后台操作
				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					url: "${pageContext.request.contextPath}/score/getStudentScoreMessage.do?studentId=" + studentId,
					//设置提交的方式
					mtype: "post",
					//使用本地数据显示
					//data: grid_data,
					...
					//colNames:[,"studentId","subjectId",'课程名称','课程上限','已选', '操作'],
                    editurl: "${pageContext.request.contextPath}/score/update.do",
					//注意。这里是一定提交id字段，还有editable设置为true的也提交上去，设置为是false的不提交后台
                    colModel:[
						{label:"id",name:'id',hidden: true,index:'id', width:60, sorttype:"int", editable: false},
                        /*{label:"学生姓名",name:'student.studentName',index:'student.studentName', width:80,editable: false},*/
                        {label:"课程名称",name:'subjectName',index:'subjectName', width:80,editable: false},
                        {label:"课程分数",name:'score',index:'score', width:80,editable: true},
                ...
                //给选课功能添加一个按钮，要进行判断如果课程上限到了，即不能选课，变成灰色
